...
void scene_train_dark_1(World *world) {
  set3f(&world->ambient, 0.0f, 0.0f, 0.0f);
...
void scene_train_final(World *world) {
  set3f(&world->ambient, 0.1f, 0.06f, 0.03f);
  //world->ambient = {};
...
Entity *make_entity(int type) {
  ...
  en->height = 10;
  en->type = type;
  set4f(&en->color, 1.f, 1.f, 1.f, 1.f);
